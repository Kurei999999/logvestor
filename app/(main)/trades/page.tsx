...
export default function TradesPage() {
  ...
  const [newTradeTemplate, setNewTradeTemplate] = useState<Trade | null>(null);
  ...
  const handleSaveNewTrade = async (trade: Trade) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Add Trade Modal */}
      {showAddTradeModal && newTradeTemplate && (
        <TradeEditModal
          trade={newTradeTemplate}
